...
abstract public class AbstractSerialTransportListener {
     ...
     */
    public void beforeMessageWrite(SerialConnection port, ModbusMessage msg) {
    }
     ...
     */
    public void afterMessageWrite(SerialConnection port, ModbusMessage msg) {
    }
     ...
     */
    public void beforeRequestRead(SerialConnection port) {
    }
     ...
     */
    public void afterRequestRead(SerialConnection port, ModbusRequest req) {
    }
     ...
     * @param port Port to read
     */
    public void beforeResponseRead(SerialConnection port) {
    }
     ...
     */
    public void afterResponseRead(SerialConnection port, ModbusResponse res) {
    }
}
